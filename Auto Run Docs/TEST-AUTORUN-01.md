...
- [x] Run targeted utility tests with `npm run test:jest -- src/utils/__tests__/statsCalculator.test.ts` and confirm Jest exits with code 0.
  - Completed in loop `00001` on `2026-02-15`: Jest exited with code `0` (20/20 tests passed).
